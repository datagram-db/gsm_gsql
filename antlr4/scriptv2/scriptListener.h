...
public:
  ...
  virtual void enterExpr_block(scriptParser::Expr_blockContext *ctx) = 0;
  virtual void exitExpr_block(scriptParser::Expr_blockContext *ctx) = 0;

  virtual void enterInner_block(scriptParser::Inner_blockContext *ctx) = 0;
  virtual void exitInner_block(scriptParser::Inner_blockContext *ctx) = 0;

  virtual void enterIn_tuple_pair(scriptParser::In_tuple_pairContext *ctx) = 0;
  virtual void exitIn_tuple_pair(scriptParser::In_tuple_pairContext *ctx) = 0;
  ...
  virtual void enterTerm_operand(scriptParser::Term_operandContext *ctx) = 0;
  virtual void exitTerm_operand(scriptParser::Term_operandContext *ctx) = 0;
  ...
  virtual void enterCp(scriptParser::CpContext *ctx) = 0;
  virtual void exitCp(scriptParser::CpContext *ctx) = 0;

  virtual void enterExprterm(scriptParser::ExprtermContext *ctx) = 0;
  virtual void exitExprterm(scriptParser::ExprtermContext *ctx) = 0;
