...
public:
  ...
  virtual std::any visitExpr_block(scriptParser::Expr_blockContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitInner_block(scriptParser::Inner_blockContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitIn_tuple_pair(scriptParser::In_tuple_pairContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitTerm_operand(scriptParser::Term_operandContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitCp(scriptParser::CpContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitExprterm(scriptParser::ExprtermContext *ctx) override {
    return visitChildren(ctx);
  }
